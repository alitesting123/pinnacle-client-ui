import { ProposalData, ProposalSection, EventDetails, TimelineEvent, Suggestion } from '@/types/proposal';
...
export const mockSuggestions: Suggestion[] = [
  ...
  {
    id: 'projection-alternative',
    type: 'alternative',
    title: 'LED Wall Alternative',
    description: 'Consider LED wall instead of projection for brighter, more vibrant visuals.',
    originalCost: 7200,
    suggestedCost: 9600,
    savings: -2400,
    confidence: 'low'
...
export const mockProposalData: ProposalData = {
  eventDetails: mockEventDetails,
  sections: mockSections,
  totalCost: mockSections.reduce((total, section) => total + section.total, 0),
